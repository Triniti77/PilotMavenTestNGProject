...
//        capabilities.setCapability(MobileCapabilityType.UDID, "emulator-5554");
    ...
    private void findElements() {
        ...
        sub = appiumDriver.findElement(By.xpath("//android.widget.Button[contains(@resource-id, 'op_sub')]"));
    ...
    private void findElements10() {
        ...
        eight = appiumDriver.findElement(By.xpath("//android.widget.Button[contains(@resource-id, 'digit_8')]"));
        nine = appiumDriver.findElement(By.xpath("//android.widget.Button[contains(@resource-id, 'digit_9')]"));
        plus = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'op_add')]"));
        div = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'op_div')]"));
        sub = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'op_sub')]"));
        point = appiumDriver.findElement(By.xpath("//android.widget.Button[contains(@resource-id, 'dec_point')]"));
        eq = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'eq')]"));
        results = appiumDriver.findElement(By.xpath("//android.widget.EditText[contains(@resource-id, 'formula')]"));
        mult = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'op_mul')]"));
        del = appiumDriver.findElement(By.xpath("//android.widget.ImageView[contains(@resource-id, 'del')]"));
    }
